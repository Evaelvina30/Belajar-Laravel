  ...
  <body>
        ...
        <div class="login-body text-dark col-12">
          <div class="row">
            <div class="col-3">
              <a href="" class="">
                <img
                  src="{{asset('./../icon/logo-sekolah/logo-muhi.png')}}"
                  alt=""
                  class="icon-back"
                />
              </a>
          ...
          <div class="mt-5">
            <a
              href="javascript:;"
              class="btn btn-yellow follow-btn btn-block"
              style="
            ...
            >
            <p
              class="text-muted text-center mt-3 mb-3"
    ...
    <script>
      $(document).ready(() => {
        ...
        //     Authorization:
        //       'Bearer 8tPeoKcgUEvJMOVzeSBow3HRIaGfcnwEVYgTuJIpBUl7qKYorR',
        //   },
        //   data: {
        //     receiver: null,
        //     device: '62877764324731',
        //     message: null,
        //     type: 'chat',
        //   },
        // };
        ...
        // $('#first_name').change(() => {
        //   let sendWA = settings;
        //   sendWA.data.receiver = $('#first_name').val();
        //   sendWA.data.message =
